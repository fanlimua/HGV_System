...
right_angle_input['strong_left'] = fuzz.trimf(right_angle_input.universe, [-90, -90, -45])
right_angle_input['left'] = fuzz.trimf(right_angle_input.universe, [-90, -45, 0])
right_angle_input['straight'] = fuzz.trimf(right_angle_input.universe, [-45, 0, 45])
right_angle_input['right'] = fuzz.trimf(right_angle_input.universe, [0, 45, 90])
right_angle_input['strong_right'] = fuzz.trimf(right_angle_input.universe, [45, 90, 90])
